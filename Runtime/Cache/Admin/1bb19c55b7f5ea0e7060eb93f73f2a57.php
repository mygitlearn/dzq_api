...
<div class="content" >
    ...
    <div class="container-fluid">
        ...
        <div id="text">
            <form action="<?php echo U();?>" method="post" name="text" id="fileForm" enctype="multipart/form-data">
                <div id="left">
                    ...
                    <p style="width:100%"> <label>乐谱简介：</label><textarea name="introduce" style="width: 80%;height: 45px"><?php echo ($list["m_intro"]); ?></textarea></p>
                </div>
                <div id="right">
                    <img id="showImg" src="<?php echo ($imgUrl); ?>">
                    <input id="upImg" class="aaaaaaaaaa" name="upImg[]" type="file" />
                </div>
